...
void	minimap_render(t_wolf *wolf, t_s32 minimap_width, t_s32 minimap_height)
{
	t_s32	x;
	t_s32	y;
...
void	uniform_translation(t_s32 transform[2], t_s32 width, t_s32 height, t_wolf *wolf)
{
	t_s32	zoom;
